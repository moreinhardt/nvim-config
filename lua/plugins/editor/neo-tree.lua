-- adapted from: https://github.com/LazyVim/LazyVim/blob/main/lua/lazyvim/plugins/extras/editor/neo-tree.lua
return {
  -- file explorer
  ...
  dependencies = {
    ...
    { 'folke/snacks.nvim', opts = { rename = { enabled = true } } },
  },
  lazy = false,
  keys = {
    {
      '<leader>e',
      function() require('neo-tree.command').execute { toggle = true, dir = vim.fs.root(0, { '.git', '.hg', '.svn' }) or vim.uv.cwd() } end,
